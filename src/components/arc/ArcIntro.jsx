  ...
  return (
    <section className="relative w-full py-32 flex items-center justify-center p-6 sm:p-12 z-10">
      <div className="max-w-4xl mx-auto text-center space-y-12">
        <h2 
          className="text-4xl md:text-6xl font-serif tracking-tight leading-tight text-[var(--arc-text-primary)] mb-6"
          style={{ fontWeight: 300 }}
        >
          One API to rule them all.
        </h2>
        <div className="text-xl md:text-2xl text-[var(--arc-text-secondary)] font-serif font-light leading-relaxed max-w-3xl mx-auto space-y-6">
          <p>
