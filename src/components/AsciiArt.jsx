...
export default function AsciiArt({ width = 80, height = 24, numCircles = 8, className = "" }) {
  ...
  return (
    <div
      className={`font-mono text-xs leading-none whitespace-pre overflow-hidden select-none pointer-events-none ${className || "opacity-[15%] dark:opacity-20"}`}
      aria-hidden="true"
