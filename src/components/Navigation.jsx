        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              ...
              <Link
                href="/preorder"
                className="btn-shine bg-black hover:bg-cornerstone hover:text-white hover:border-cornerstone border border-black dark:bg-white dark:text-black dark:hover:bg-cornerstone dark:hover:text-white dark:hover:border-cornerstone dark:border-white text-white text-xs px-3 py-1.5 rounded-full font-[500] font-mono transition-colors"
              >
                Buy
              </Link>
            </div>
        ...
        >
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <div className="pt-4">
              <Link
                href="/preorder"
                className="btn-shine block w-full text-center bg-black hover:bg-cornerstone hover:text-white hover:border-cornerstone border border-black dark:bg-white dark:text-black dark:hover:bg-cornerstone dark:hover:text-white dark:hover:border-cornerstone dark:border-white text-white px-4 py-2 rounded-full font-medium font-mono transition-colors"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Buy
              </Link>
