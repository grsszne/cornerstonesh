          ...
          <FadeIn>
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-6xl font-medium tracking-tighter mb-6">
                Choose Your <span className="text-cornerstone">Hardware.</span>
              </h1>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-black/10 dark:border-white/10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {/* N100 8GB */}
            <FadeIn delay={0.1}>
              <div className="border border-black/20 dark:border-white/20 p-8 rounded-2xl h-full hover:border-cyan-500 transition-colors duration-300">
                <div className="mb-6">
                  <div className="font-mono text-xs text-cyan-500 uppercase tracking-widest mb-2">Entry</div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm opacity-80">
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Plex/Jellyfin (1-2 4K transcodes)</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> File storage (NAS, SMB, NFS)</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Pi-hole / AdGuard / Unbound</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> 3-5 light containers</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Nextcloud (personal use)</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Reverse proxy (Nginx, Caddy)</li>
                    </ul>
                  </div>
                  ...
                  <div className="pt-4 border-t border-black/10 dark:border-white/10">
                    ...
                    <div className="text-sm font-medium">
                      Idle: <span className="text-cyan-500">~8W</span> | Load: <span className="text-cyan-500">~15W</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* N100 16GB */}
            <FadeIn delay={0.2}>
              <div className="border border-black/20 dark:border-white/20 p-8 rounded-2xl h-full hover:border-green-500 transition-colors duration-300">
                <div className="mb-6">
                  <div className="font-mono text-xs text-green-500 uppercase tracking-widest mb-2">Popular</div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="text-xs font-mono uppercase opacity-40 mb-3">Best For</div>
                    <ul className="space-y-2 text-sm opacity-80">
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> 10+ Docker containers</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> 1-2 lightweight VMs (Proxmox)</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Home Assistant + addons</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Development environments</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> PostgreSQL / MySQL / Redis</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Gitea / GitLab (small teams)</li>
                    </ul>
                  </div>
                  ...
                  <div className="pt-4 border-t border-black/10 dark:border-white/10">
                    <div className="text-xs font-mono uppercase opacity-40 mb-2">Power Estimate</div>
                    <div className="text-sm font-medium">
                      Idle: <span className="text-green-500">~9W</span> | Load: <span className="text-green-500">~18W</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* N305 16GB */}
            <FadeIn delay={0.3}>
              <div className="border border-black/20 dark:border-white/20 p-8 rounded-2xl h-full hover:border-purple-500 transition-colors duration-300">
                <div className="mb-6">
                  <div className="font-mono text-xs text-purple-500 uppercase tracking-widest mb-2">Performance</div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="text-xs font-mono uppercase opacity-40 mb-3">Best For</div>
                    <ul className="space-y-2 text-sm opacity-80">
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Kubernetes (K3s/K8s) clusters</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> 4-5 simultaneous 4K transcodes</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> 20+ Docker containers</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> 3-4 concurrent VMs</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> CI/CD pipelines (Jenkins, Drone)</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Machine learning inference</li>
                    </ul>
                  </div>
                  ...
                  <div className="pt-4 border-t border-black/10 dark:border-white/10">
                    <div className="text-xs font-mono uppercase opacity-40 mb-2">Power Estimate</div>
                    <div className="text-sm font-medium">
                      Idle: <span className="text-purple-500">~12W</span> | Load: <span className="text-purple-500">~28W</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <FadeIn delay={0.4}>
            <div className="bg-cyan-500/5 border border-cyan-500/20 rounded-2xl p-8">
              <div className="font-mono text-xs text-cyan-500 uppercase tracking-widest mb-3">Quick Guide</div>
              <h3 className="text-2xl font-medium mb-4">Which should I choose?</h3>
              <div className="space-y-3 font-mono text-sm opacity-80">
                <p><span className="text-cyan-500 font-bold">N100 8GB:</span> You're new to home servers or just want simple file storage and media streaming.</p>
                <p><span className="text-green-500 font-bold">N100 16GB:</span> You plan to run 10+ services/containers or want room to experiment.</p>
                <p><span className="text-purple-500 font-bold">N305 16GB:</span> You're running production workloads, Kubernetes, or need maximum performance.</p>
              </div>
            </div>
          </FadeIn>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <FadeIn delay={0.1}>
              <div className="border border-black/20 dark:border-white/20 p-8 rounded-2xl h-full hover:border-cyan-500 transition-colors duration-300">
                <div className="mb-6">
                  <div className="font-mono text-xs text-cyan-500 uppercase tracking-widest mb-2">Standard</div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="text-xs font-mono uppercase opacity-40 mb-3">Best For</div>
                    <ul className="space-y-2 text-sm opacity-80">
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Streaming 4K video (multiple streams)</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> File browsing & document access</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Photo library access</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Cloud sync & backups</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Standard home networking</li>
                    </ul>
                  </div>
                  ...
                  <div className="pt-4 border-t border-black/10 dark:border-white/10">
                    ...
                    <div className="space-y-1 text-sm font-medium">
                      <div>100GB video: <span className="text-cornerstone">~13 min</span></div>
                      <div>1TB backup: <span className="text-cornerstone">~2.2 hours</span></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <FadeIn delay={0.2}>
              <div className="border border-black/20 dark:border-white/20 p-8 rounded-2xl h-full hover:border-green-500 transition-colors duration-300">
                <div className="mb-6">
                  <div className="font-mono text-xs text-green-500 uppercase tracking-widest mb-2">Upgrade</div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="text-xs font-mono uppercase opacity-40 mb-3">Best For</div>
                    <ul className="space-y-2 text-sm opacity-80">
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Video editing (1080p/4K projects)</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Large file transfers</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Camera footage offload</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Multi-user home networks</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Time Machine backups</li>
                    </ul>
                  </div>
                  ...
                  <div className="pt-4 border-t border-black/10 dark:border-white/10">
                    <div className="text-xs font-mono uppercase opacity-40 mb-2">Transfer Examples</div>
                    <div className="space-y-1 text-sm font-medium">
                      <div>100GB video: <span className="text-cornerstone">~5 min</span></div>
                      <div>1TB backup: <span className="text-cornerstone">~53 min</span></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <FadeIn delay={0.3}>
              <div className="border border-black/20 dark:border-white/20 p-8 rounded-2xl h-full hover:border-purple-500 transition-colors duration-300">
                <div className="mb-6">
                  <div className="font-mono text-xs text-purple-500 uppercase tracking-widest mb-2">Fast</div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="text-xs font-mono uppercase opacity-40 mb-3">Best For</div>
                    <ul className="space-y-2 text-sm opacity-80">
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> 4K/6K video editing</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> RAW photo workflows (50+ MB files)</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Rapid backup & restore</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Small creative teams (2-4 users)</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> VM storage over network</li>
                    </ul>
                  </div>
                  ...
                  <div className="pt-4 border-t border-black/10 dark:border-white/10">
                    <div className="text-xs font-mono uppercase opacity-40 mb-2">Transfer Examples</div>
                    <div className="space-y-1 text-sm font-medium">
                      <div>100GB video: <span className="text-cornerstone">~2.5 min</span></div>
                      <div>1TB backup: <span className="text-cornerstone">~27 min</span></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* 10GbE */}
            <FadeIn delay={0.4}>
              <div className="border border-black/20 dark:border-white/20 p-8 rounded-2xl h-full hover:border-cornerstone transition-colors duration-300">
                <div className="mb-6">
                  <div className="font-mono text-xs text-cornerstone uppercase tracking-widest mb-2">Maximum</div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="text-xs font-mono uppercase opacity-40 mb-3">Best For</div>
                    <ul className="space-y-2 text-sm opacity-80">
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> 8K video production</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Multiple simultaneous editors</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> VM/container cluster storage</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> Database servers & analytics</li>
                      <li className="flex gap-2"><span className="text-cornerstone">→</span> iSCSI / NVMe-oF targets</li>
                    </ul>
                  </div>
                  ...
                  <div className="pt-4 border-t border-black/10 dark:border-white/10">
                    <div className="text-xs font-mono uppercase opacity-40 mb-2">Transfer Examples</div>
                    <div className="space-y-1 text-sm font-medium">
                      <div>100GB video: <span className="text-cornerstone">~80 sec</span></div>
                      <div>1TB backup: <span className="text-cornerstone">~13 min</span></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Boot Storage */}
              <FadeIn delay={0.1}>
                <div className="border border-black/20 dark:border-white/20 p-8 rounded-2xl hover:border-cyan-500 transition-colors duration-300">
                  <div className="mb-6">
                    <div className="font-mono text-xs text-cyan-500 uppercase tracking-widest mb-2">System Drive</div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm opacity-80">
                        <li className="flex gap-2"><span className="text-cyan-500">→</span> <span className="font-bold">256GB:</span> Minimal OS + 3-5 containers</li>
                        <li className="flex gap-2"><span className="text-cyan-500">→</span> <span className="font-bold">512GB:</span> Most users — room for 10+ containers</li>
                        <li className="flex gap-2"><span className="text-cyan-500">→</span> <span className="font-bold">1TB:</span> Heavy Docker + VM images</li>
                        <li className="flex gap-2"><span className="text-cyan-500">→</span> <span className="font-bold">2-4TB:</span> Local databases + container volumes</li>
                        <li className="flex gap-2"><span className="text-cyan-500">→</span> <span className="font-bold">8TB:</span> Maximum — all workloads on fast storage</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              {/* Modular Storage */}
              <FadeIn delay={0.2}>
                <div className="border border-black/20 dark:border-white/20 p-8 rounded-2xl hover:border-green-500 transition-colors duration-300">
                  <div className="mb-6">
                    <div className="font-mono text-xs text-green-500 uppercase tracking-widest mb-2">Modular Bays</div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm opacity-80">
                        <li className="flex gap-2"><span className="text-cornerstone">→</span> <span className="font-bold">2× 2TB mirror:</span> 2TB redundant storage</li>
                        <li className="flex gap-2"><span className="text-cornerstone">→</span> <span className="font-bold">4× 4TB RAID5:</span> 12TB with parity</li>
                        <li className="flex gap-2"><span className="text-cornerstone">→</span> <span className="font-bold">6× 4TB RAID6:</span> 16TB with 2-disk fault tolerance</li>
                        <li className="flex gap-2"><span className="text-cornerstone">→</span> <span className="font-bold">7× 8TB JBOD:</span> 64TB maximum raw</li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <FadeIn delay={0.3}>
              <div className="bg-cornerstone/5 border border-cornerstone/20 rounded-2xl p-8">
                <div className="font-mono text-xs text-cornerstone uppercase tracking-widest mb-3">Storage Guide</div>
                ...
                <div className="pt-6 border-t border-cornerstone/20">
                  <div className="font-mono text-xs text-cornerstone uppercase tracking-widest mb-3">Pro Tip</div>
            ...
            <FadeIn delay={0.4}>
              <div className="mt-12 border border-black/10 dark:border-white/10 rounded-2xl p-8 md:p-12">
                ...
                <div className="text-center mb-8">
                  <div className="font-mono text-sm text-cornerstone uppercase tracking-widest mb-2">Storage Capacity</div>
                  <div className={`text-6xl md:text-8xl font-bold mb-4 transition-all duration-300 ${currentStorage.highlight ? 'text-cornerstone' : ''}`}>
                    {currentStorage.size}
                  </div>
                ...
                <div className="mb-12 px-4">
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, rgb(247, 130, 27) 0%, rgb(247, 130, 27) ${(currentStorageIndex / (STORAGE_SIZES.length - 1)) * 100}%, rgba(0,0,0,0.1) ${(currentStorageIndex / (STORAGE_SIZES.length - 1)) * 100}%, rgba(0,0,0,0.1) 100%)`
                    }}
                  />
              ...
              <style jsx>{`
                ...
                .slider::-webkit-slider-thumb {
                  ...
                  height: 24px;
                  border-radius: 50%;
                  background: rgb(247, 130, 27);
                  cursor: pointer;
                  box-shadow: 0 2px 8px rgba(247, 130, 27, 0.3);
                  transition: all 0.2s;
                }

                .slider::-webkit-slider-thumb:hover {
                  transform: scale(1.2);
                  box-shadow: 0 4px 12px rgba(247, 130, 27, 0.5);
                }
        ...
        <div className="max-w-7xl mx-auto text-center">
          <FadeIn>
            <h2 className="text-3xl md:text-5xl font-medium tracking-tight mb-8">
              Ready to <span className="text-cornerstone">Build?</span>
            </h2>
            ...
            <Link
              ...
              className="inline-flex items-center justify-center px-8 py-4 text-base font-mono font-medium uppercase tracking-wider bg-black text-white dark:bg-white dark:text-black border border-black dark:border-white hover:bg-cornerstone hover:border-cornerstone dark:hover:bg-cornerstone dark:hover:border-cornerstone transition-colors duration-300"
            >
