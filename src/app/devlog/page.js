...
const devlogPosts = [
  {
    ...
    content: (
      <>
        ...
        <p className="mb-4">
          Here's the core idea: 8 universal bays that can take whatever you throw at them. Need storage? Grab some NVMe drives (you can max out at 56TB if you're crazy). Need faster networking? Pop in a 10GbE module. WiFi 6? Sure. More USB ports? Yeah. Want to design your own custom module? Go for it. Connectors are PCIe x1 based.
        </p>
        <p className="mb-4">
